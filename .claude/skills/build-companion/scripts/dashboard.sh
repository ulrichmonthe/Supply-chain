#!/usr/bin/env bash
# Serves the current project folder and opens the Build Companion panel.
...
if [ ! -f "dashboard.html" ]; then
  ...
  echo "Copied dashboard.html into this project."
fi

URL="http://localhost:${PORT}/dashboard.html"
echo "Build Companion → ${URL}   (keep it beside your Claude Code window; Ctrl-C stops it)"
